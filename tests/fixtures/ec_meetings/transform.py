...
def make_address(ctx: SourceContext, data: Record) -> StatementEntity:
...
def make_person(
    ctx: SourceContext, name: str, role: str, body: StatementEntity
) -> StatementEntity:
...
def make_organizations(ctx: SourceContext, data: Record) -> StatementEntities:
...
def make_persons(
    ctx: SourceContext, data: Record, body: StatementEntity
) -> StatementEntities:
...
def make_event(
    ctx: SourceContext,
    data: Record,
    organizer: StatementEntity,
    involved: list[StatementEntity],
) -> StatementEntities:
    ...
    proxy = ctx.make_entity("Event", id_)
...
def parse_record(
    ...
    for member in involved:
        ...
        rel = ctx.make_entity("Membership", id_)
...
def parse_record_ec(ctx: SourceContext, data: Record) -> StatementEntities:
...
def parse_record_dg(ctx: SourceContext, data: Record) -> StatementEntities:
...
def handle(ctx: SourceContext, record: Record, ix: int) -> StatementEntities:
