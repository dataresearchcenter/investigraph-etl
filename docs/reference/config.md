...
When not using blocks (as for local development), any arbitrary config files can be referenced to use via [command line](./cli.md):
...
Turn off aggregation completely:
